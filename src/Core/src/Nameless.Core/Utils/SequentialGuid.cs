...
namespace Nameless {
	...
	public static class SequentialGuid {
		...
		/// </para>
		/// </remarks>
		public static Guid NewGuid(SequentialType type = SequentialType.AtEnd, bool useRandomNumberGenerator = false) {
			...
			if (useRandomNumberGenerator) { RandomGenerator.GetBytes(randomBytes); }
			else { randomBytes = Guid.NewGuid().ToByteArray(); }
